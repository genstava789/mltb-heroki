...
c2aira --allow-overwrite=true --auto-file-renaming=true --bt-detach-seed-only=true --bt-enable-lpd=true --bt-max-peers=0 \
       ...
       --min-split-size=1024M --optimize-concurrent-downloads=true --peer-agent=qBittorrent/4.6.5 --peer-id-prefix=-qB4650- \
       --quiet=true --reuse-uri=true --rpc-max-request-size=1024M --seed-ratio=0 --split=16 --summary-interval=0 --user-agent=Wget/1.24
